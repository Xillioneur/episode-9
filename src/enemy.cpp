...
void ShadowDrone::Draw() {
    ...
    // Wings using DrawCube (simplified rotation)
    DrawCube(Vector3Add(position, {0.6f, 0, 0}), 0.8f, 0.1f, 0.4f, color);
    DrawCube(Vector3Subtract(position, {0.6f, 0, 0}), 0.8f, 0.1f, 0.4f, color);
...
void TemptationBeast::Draw() {
    ...
    // Corrected Horns using DrawCylinder
    DrawCylinder(Vector3Add(position, {1.0f, 1.0f, 1.0f}), 0.2f, 0.05f, 1.0f, 6, GRAY);
    DrawCylinder(Vector3Add(position, {-1.0f, 1.0f, 1.0f}), 0.2f, 0.05f, 1.0f, 6, GRAY);
